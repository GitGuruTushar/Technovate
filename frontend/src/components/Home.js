    ...
    series: [
      {
        ...
        data: [
          2693034100, 2528133480, 2320678660, 2541365980, 2573606310,
          2434123800,
        ],
      },
      {
    ...
    `,
      ...
      >
        <div className="landing-page" style={{ height: "100vh" }}>
          ...
          >
            ...
            <p style={{ fontSize: "1.2rem", maxWidth: "700px" }}>
              ...
              make eco-friendly choices and contribute to a healthier planet.
              Join us in the journey to sustainability! <br />
              Join the journey towards a sustainable future. Monitor, reduce,
              and offset your carbon emissions with EcoTrack.
            </p>
        ...
        >
          <div className="about">
            <h2 style={{ color: "#fff" }}>
              What is <span style={{ color: "aqua" }}>EcoTrack?</span>
            </h2>
            <p style={{ color: "#fff" }}>
              ...
              impact on the environment, and provides actionable insights to
        ...
        >
          ...
          >
            ...
            <div className="step">
              ...
              <p style={{ color: "#fff" }}>
                Input your daily activities or sync with your apps to monitor
                your energy usage, transportation, and more.
              </p>
            </div>
            <div className="step">
            ...
            <div className="step">
              ...
              <p style={{ color: "#fff" }}>
                Participate in eco-friendly challenges, offset your emissions,
                and share your progress with the EcoTrack community.
              </p>
            </div>
          </div>
          <div
        ...
        >
          ...
          >
            <h2 style={{ color: "#fff" }}>
              Why Reduce Your{" "}
              <span style={{ color: "aqua" }}>Carbon Footprint</span>?
            </h2>
            <p style={{ color: "#fff" }}>
            ...
            <ul>
              <li style={{ color: "#fff" }}>
                70% of global carbon emissions come from cities.
              </li>
              <li style={{ color: "#fff" }}>
